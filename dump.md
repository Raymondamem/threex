<!-- first -->
<!DOCTYPE html>
<script src='./public/vendor/three.js/build/three.min.js'></script>
<script src='./public/js/threex.planets.js'></script>
<script src='./public/js/threex.atmospherematerial.js'></script>
<!-- include for threex.glowdatgui -->
<script src='./public/vendor/three.js/examples/js/libs/dat.gui.min.js'></script>
<script src="./public/js/threex.atmospheredatgui.js"></script>
